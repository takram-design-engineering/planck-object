...
describe('LineSegments', () => {
  it('is instance of Three.LineSegments', () => {
    const object = new LineSegments()
    expect(object).instanceof(Three.LineSegments)
  })

  describe('#add', () => {
    it('dispatches event with `to` property', () => {
      const parent = new LineSegments()
      const child = new LineSegments()
  ...
  describe('#addedToScene', () => {
    it('is called when added to the scene graph', () => {
      ...
      const parent = new LineSegments()
      const child1 = new LineSegments()
      const child2 = new LineSegments()
